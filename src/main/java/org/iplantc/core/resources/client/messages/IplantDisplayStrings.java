...
public interface IplantDisplayStrings extends com.google.gwt.i18n.client.Messages {
  ...
  /**
   * Translated "&nbsp;Click on the app name to edit. To re-categorize an app, drag and drop it into appropriate category in the categories tree.".
   *
   * @return translated "&nbsp;Click on the app name to edit. To re-categorize an app, drag and drop it into appropriate category in the categories tree."
   */
  ...
  /**
   * Translated "This will remove selected analyses. Outputs and parameters can still be viewed in the folder in Manage Data that was created by these analyses.".
   *
   * @return translated "This will remove selected analyses. Outputs and parameters can still be viewed in the folder in Manage Data that was created by these analyses."
   */
  ...
  /**
   * Translated "Your analysis has been submitted. You will be notified about its progress through notifications.".
   *
   * @return translated "Your analysis has been submitted. You will be notified about its progress through notifications."
   */
   ...
   *
   * @return translated "This will remove the selected app from your workspace. Do you wish to continue?"
   */
  ...
  /**
   * Translated "You have selected a non-empty folder. This may cause files in the folder to be overwritten. Continue?".
   *
   * @return translated "You have selected a non-empty folder. This may cause files in the folder to be overwritten. Continue?"
   */
  ...
  /**
   * Translated "Retain Inputs? Enabling this flag will copy all the input files into the analysis result folder.".
   *
   * @return translated "Retain Inputs? Enabling this flag will copy all the input files into the analysis result folder."
   */
  ...
  /**
   * Translated "Only 8K of the selected file is displayed. For full view of data, please download file.".
   *
   * @return translated "Only 8K of the selected file is displayed. For full view of data, please download file."
   */
  ...
  /**
   * Translated "Are you sure you want to close this window? Closing may interrupt any transfers in progress.".
   *
   * @return translated "Are you sure you want to close this window? Closing may interrupt any transfers in progress."
   */
  ...
  /**
   * Translated "You must close this window, after the current download is complete, before beginning a new download.".
   *
   * @return translated "You must close this window, after the current download is complete, before beginning a new download."
   */
  ...
  /**
   * Translated "Currently, only linear workflows may be created. At least one input for each app must come from an output of a previous app.".
   *
   * @return translated "Currently, only linear workflows may be created. At least one input for each app must come from an output of a previous app."
   */
  ...
  /**
   * Translated "A valid URL must begin with either ftp or http or https and cannot end with a space or a /. It must contain a valid path to a file after the domain name.".
   *
   * @return translated "A valid URL must begin with either ftp or http or https and cannot end with a space or a /. It must contain a valid path to a file after the domain name."
   */
  ...
  /**
   * Translated "Please click <a href=''{0}''>here</a> if not redirected to the logout page within a few seconds.".
   *
   * @return translated "Please click <a href=''{0}''>here</a> if not redirected to the logout page within a few seconds."
   */
  ...
  /**
   * Translated "You will be logged out from all the active sessions of Discovery Environment and Tool Integration.".
   *
   * @return translated "You will be logged out from all the active sessions of Discovery Environment and Tool Integration."
   */
  ...
  /**
   * Translated "Your app is now public. Please complete the <a href=\"{0}\" target=\"_blank\">documentation page</a>.".
   *
   * @return translated "Your app is now public. Please complete the <a href=\"{0}\" target=\"_blank\">documentation page</a>."
   */
  ...
  /**
   * Translated "Letters, numbers, hyphens (-), underscores (_), and periods (.) are allowed. Spaces may be used if not at the beginning or end of the file name.".
   *
   * @return translated "Letters, numbers, hyphens (-), underscores (_), and periods (.) are allowed. Spaces may be used if not at the beginning or end of the file name."
   */
  ...
  /**
   * Translated "You are about to navigate away from this page. Unsaved changes will be lost. Do you wish to continue?".
   *
   * @return translated "You are about to navigate away from this page. Unsaved changes will be lost. Do you wish to continue?"
   */
  ...
  /**
   * Translated "You have new notifications. Please select 'Notifications' link from top level menu to view them.".
   *
   * @return translated "You have new notifications. Please select 'Notifications' link from top level menu to view them."
   */
  ...
  /**
   * Translated "The iPlant Collaborative is funded by a grant from the National Science Foundation Plant Science Cyberinfrastructure Collaborative (#DBI-0735191).".
   *
   * @return translated "The iPlant Collaborative is funded by a grant from the National Science Foundation Plant Science Cyberinfrastructure Collaborative (#DBI-0735191)."
   */
  ...
  /**
   * Translated "You have your pop-up blocker enabled. Please click the Ok button to complete your action. Please disable your pop-up blocker in the future.".
   *
   * @return translated "You have your pop-up blocker enabled. Please click the Ok button to complete your action. Please disable your pop-up blocker in the future."
   */
  ...
  /**
   * Translated "<p>This option allows the Data Manager to automatically navigate the file tree to the file location that was used the last time you ran that app.</p> <br/> <p> This option is helpful if you have an extensive file tree or often use the same input file location.</p>".
   *
   * @return translated "<p>This option allows the Data Manager to automatically navigate the file tree to the file location that was used the last time you ran that app.</p> <br/> <p> This option is helpful if you have an extensive file tree or often use the same input file location.</p>"
   */
  ...
  /**
   * Translated "Your request for new tool deployment has been submitted. You will receive an email confirmation.".
   *
   * @return translated "Your request for new tool deployment has been submitted. You will receive an email confirmation."
   */
  ...
  /**
   * Translated "\"{0}\" cannot be restored automatically since it is orphaned. Please drag and drop it into appropriate category.".
   *
   * @return translated "\"{0}\" cannot be restored automatically since it is orphaned. Please drag and drop it into appropriate category."
   */
   ...
   *
   * @return translated "Select output folder (a sub-folder will created by default when {0} is selected)"
   */
  ...
  /**
   * Translated "Your request has been submitted. You will receive notifications when the request is complete.".
   *
   * @return translated "Your request has been submitted. You will receive notifications when the request is complete."
   */
  ...
  /**
   * Translated "Enter the URL for the iPlant wiki documentation, created using <a href=\"{0}\" target=\"_blank\">these instructions</a>".
   *
   * @return translated "Enter the URL for the iPlant wiki documentation, created using <a href=\"{0}\" target=\"_blank\">these instructions</a>"
   */
