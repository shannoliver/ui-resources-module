 ...
 * /Users/sriram
 * /iplant/lib-workspace/ui-resources-module/src/main/resources/org/
 * iplantc/core/resources/client/messages/I18N.properties'.
 */
public interface IplantDisplayStrings extends
	...
	/**
	 * Translated
	 * "Analyses that are not in completed or failed status were not deleted.".
	 *
	 * @return translated
	 *         "Analyses that are not in completed or failed status were not deleted."
	 */
	...
	/**
	 * Translated
	 * "Please add a comment to accompany your rating of the {0} tool:".
	 *
	 * @return translated
	 *         "Please add a comment to accompany your rating of the {0} tool:"
	 */
	 ...
	 *
	 * @return translated
	 *         "Attach generated output files and logs (zip multiple files)"
	 */
	...
	/**
	 * Translated
	 * "There are unsaved changes. Do you still want to close the window ?".
	 *
	 * @return translated
	 *         "There are unsaved changes. Do you still want to close the window ?"
	 */
	...
	/**
	 * Translated
	 * "Your search exceeded the threshold. Please refine your search.".
	 *
	 * @return translated
	 *         "Your search exceeded the threshold. Please refine your search."
	 */
	 ...
	 * Translated "
	 * <p>
	 * This will be the default location where all outputs from your analyses
	 * can be found.
	 * </p>
	 * <br/>
	 * <p>
	 ...
	 * @return translated "
	 *         <p>
	 *         This will be the default location where all outputs from your
	 *         analyses can be found.
	 *         </p>
	 * <br/>
	 *         <p>
	 *         You can keep the default path or click Browse to select a new
	 *         location.
	 *         </p>
	 *         "
	 */
	...
	/**
	 * Translated
	 * "Deleting will permanently remove files from your data list and cause dependent analyses to fail.  Do you wish to continue?"
	 * .
	 *
	 * @return translated
	 *         "Deleting will permanently remove files from your data list and cause dependent analyses to fail.  Do you wish to continue?"
	...
	/**
	 * Translated
	 * "All are deleted files and folders are available under trash.".
	 *
	 * @return translated
	 *         "All are deleted files and folders are available under trash."
	 */
	...
	/**
	 * Translated "<br/>
	 * You have selected a folder for deletion.<br/>
	 * <br/>
	 * This will remove all associated files. This action<br/>
	 * cannot be undone.<br/>
	 * <br/>
	 ...
	 *
	 * @return translated
	 *         "Argument, idParent, must have a valid value provided."
	 */
	 ...
	 * Translated "
	 * <p>
	 * This option will send you an email when the status of your analysis
	 * changes (running, completed, failed, etc.).
	 * </p>
	 * <p>
	 * It will be sent to the email address you used to register for your iPlant
	 * account.
	 * </p>
	 * <br/>
	 * <p>
	 * This option is helpful if you would like to track your analysis status
	 * while outside of the Discovery Environment.
	 * </p>
	 * ".
	 *
	 * @return translated "
	 *         <p>
	 *         This option will send you an email when the status of your
	 *         analysis changes (running, completed, failed, etc.).
	 *         </p>
	 *         <p>
	 *         It will be sent to the email address you used to register for
	 *         your iPlant account.
	 *         </p>
	 * <br/>
	 *         <p>
	 *         This option is helpful if you would like to track your analysis
	 *         status while outside of the Discovery Environment.
	 *         </p>
	 *         "
	 */
	...
	/**
	 * Translated
	 * "Your workflow has been successfully published into your workspace.".
	 *
	 * @return translated
	 *         "Your workflow has been successfully published into your workspace."
	 */
	...
	/**
	 * Translated
	 * "Your Discovery Environment app {0} has received a rating by a user.".
	 *
	 * @return translated
	 *         "Your Discovery Environment app {0} has received a rating by a user."
	 */
	 ...
	 * Translated "
	 * <p>
	 * This option allows the Data Manager to automatically navigate the file
	 * tree to the file location that was used the last time you ran that app.
	 * </p>
	 * <br/>
	 * <p>
	 * This option is helpful if you have an extensive file tree or often use
	 * the same input file location.
	 * </p>
	 * ".
	 *
	 * @return translated "
	 *         <p>
	 *         This option allows the Data Manager to automatically navigate the
	 *         file tree to the file location that was used the last time you
	 *         ran that app.
	 *         </p>
	 * <br/>
	 *         <p>
	 *         This option is helpful if you have an extensive file tree or
	 *         often use the same input file location.
	 *         </p>
	 *         "
	 */
	...
	/**
	 * Translated
	 * "Selected files and folders are restored to their original location.".
	 *
	 * @return translated
	 *         "Selected files and folders are restored to their original location."
	 */
	 ...
	 * Translated "
	 * <p>
	 * Enabling the Save session option will restore your Discovery Environment
	 * desktop to exactly how you left it when you last logged out.
	 * </p>
	 * ".
	 *
	 * @return translated "
	 *         <p>
	 *         Enabling the Save session option will restore your Discovery
	 *         Environment desktop to exactly how you left it when you last
	 *         logged out.
	 *         </p>
	 *         "
	 */
